...
import 'package:hanoi_tower/components/stick.dart';
...
class GameScreen extends StatefulWidget {
  GameScreen({super.key, required this.title, required this.level});
  final String title;
  int level;
...
class _GameScreenState extends State<GameScreen> with ChangeNotifier {
                  ...
                  if (stick3.diskNumbers.length == initialDiskNumber)
                    FutureBuilder(
                      future: underBestCounter()
                          ? makeLevelCompleted(counter, widget.level,
                              stopwatch.elapsed.inSeconds)
                          : makeLevelCompletedWithExtraAttempts(counter,
                              widget.level, stopwatch.elapsed.inSeconds),
